export const INDIA_STATES_AND_DISTRICTS: Record<string, string[]> = {
  ...
  "Arunachal Pradesh": ["Anjaw", "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Kamle", "Kra Daadi", "Kurung Kumey", "Lepa Rada", "Lohit", "Longding", "Namsai", "Pakke Kessang", "Papum Pare", "Shi Yomi", "Siang", "Tawang", "Tirap", "Lower Dibang Valley", "Lower Siang", "Lower Subansiri", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang"],
  ...
  "Jammu and Kashmir": ["Anantnag", "Bandipora", "Baramulla", "Budgam", "Doda", "Ganderbal", "Jammu", "Kathua", "Kishtwar", "Kulgam", "Kupwara", "Mamban", "Poonch", "Pulwama", "Rajouri", "Ramban", "Reasi", "Samba", "Shopian", "Srinagar", "Udhampur"],
...
export const PROPERTY_AREAS_MAPPING: Record<string, Record<string, string[]>> = {
  "Tamil Nadu": {
    "Coimbatore": [
      "Alandurai",
      "Anaikatti",
