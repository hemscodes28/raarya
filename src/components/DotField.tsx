...
const DotField = memo(({
  ...
  useEffect(() => {
    ...
    function tick() {
      ...
      const isMouseActive = m.x > -1000 && m.y > -1000;
      const targetEngagement = isMouseActive ? Math.max(m.speed / 5, 0.75) : 0;
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (distSq < crSq && eng > 0.01) {
          ...
          if (isBulge) {
            const tempT = 1 - dist / cr;
            const push = tempT * tempT * p.bulgeStrength * eng;
